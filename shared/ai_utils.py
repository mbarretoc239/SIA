...
_SYSTEM_PROMPT = (
    ...
    "Comece com a saudação 'Prezado(a) prestador(a),' (nunca 'Caro prestador'). "
    ...
    "Essa frase deve descrever o que JÁ FOI identificado pela auditoria (voz passiva, ex: "
    "'foram identificadas as seguintes pendências') — NUNCA no imperativo/como se estivesse "
    "instruindo o prestador a fazer a identificação (ex: NÃO escreva 'identifique as "
    "pendências'), já que quem identificou foi a auditoria, não o prestador. "
